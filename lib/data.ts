...
function gygLink(path: string, extra = "") {
  ...
  return `https://www.getyourguide.com/${trimmed}?partner_id=${PARTNER_ID}&utm_medium=online_publisher&cmp=rome-colosseum${extra}`;
}
...
export function transformTour(t: TourRecord): Tour {
  return {
    ...
    image: t.image,
    imageAlt: t.imageAlt,
    href: gygLink(t.hrefPath, t.hrefExtra),
    featured: t.featured,
    bestFor: t.bestFor,
    priceTableColumn1: t.priceTableColumn1,
    priceTableFeature: t.priceTableFeature,
  };
}
